...
if ( ! $recipe ) :
	...
	<div class="bg-slate-50 dark:bg-slate-950">
		<div class="container mx-auto max-w-3xl px-5 py-16 md:px-8">
			<div class="rounded-3xl border border-rose-100 bg-white/90 p-8 text-center shadow-card dark:border-slate-700 dark:bg-slate-900/90">
				<h1 class="font-display text-4xl font-semibold text-stone-900 dark:text-slate-100">Recept niet gevonden</h1>
				<p class="mt-4 text-base leading-7 text-stone-600 dark:text-slate-300">Dit recept bestaat niet meer of heeft nog geen geldige permalink in de nieuwe receptendatabase.</p>
				<div class="mt-8">
					<a href="<?php echo esc_url( $archive_url ); ?>" class="inline-flex items-center gap-2 rounded-full border border-rose-200 bg-white px-5 py-3 text-sm font-semibold text-stone-700 transition hover:bg-rose-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800">
